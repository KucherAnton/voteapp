...
const Pages: React.FC = () => {
    ...
    useEffect(() => {
        if (currentState.me?.id && currentState.poll && !currentState.poll?.hasStarted) actions.setPage(AppPage.WaitingRoom)
        if (currentState.me?.id && currentState.poll?.hasStarted) actions.setPage(AppPage.Voting)
        if (currentState.me?.id && currentState.hasVoted) actions.setPage(AppPage.Results)
