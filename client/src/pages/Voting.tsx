...
const Voting: React.FC = () => {
    ...
    const toggleNomination = (id: string) => {
        ...
        if (position < 0 && hasVotesRemaining) {
            ...
            setRankings([...rankings.slice(0, position), ...rankings.slice(position + 1, rankings.length)])
    ...
    return (
        <div className='mx-auto flex flex-col w-full justify-between items-center h-full max-w-sm'>
            ...
            <div className='mx-auto flex flex-col items-center'>
                ...
                <ConfirmationDialog
                    message="You can't change votes after submitting"
                ...
                {currentState.isAdmin && (
                    <>
                        <button className='box btn-orange my-2 w-36' onClick={() => setConfirmCancel(true)}>
                            Cancel Poll
                        </button>
                        <ConfirmationDialog
                            message="You'll cancel the poll"
